...
module.exports = {
  async up(queryInterface) {
    const now = new Date();
    await queryInterface.bulkInsert("library_meta_datas", [
      {
        name: "Severity",
        label: "Severity",
    ...
    await queryInterface.bulkInsert("library_processes", [
      {
    ...
    await queryInterface.bulkInsert("library_assets", [
      {
    ...
    await queryInterface.bulkInsert("library_risk_scenarios", [
      {
