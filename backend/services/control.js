...
class ControlsService {
  ...
  static async updateMitreControl(
    mitreControlId,
    mitreControlName,
    mitreControlType,
    data
    ...
    if (!mitreControlId || !mitreControlName) {
      ...
      throw new CustomError(
        "Failed to update mitre Contol control id and name required"
      );
    }
    ...
    return await sequelize.transaction(async (t) => {
      ...
      const [mitreThreatControlUpdateCount] = await MitreThreatControl.update(
        ...
        {
          where: {
            mitreControlId: mitreControlId,
            mitreControlName: mitreControlName,
          },
          transaction: t,
        }
      );
      if (!mitreThreatControlUpdateCount) {
        console.log(
          "No mitre control record found:",
          mitreControlId,
          mitreControlName
        );
        throw new CustomError(
          Messages.MITRE_CONTROLS.NOT_FOUND,
          HttpStatus.NOT_FOUND
        );
      }
      ...
      await this.handleMitreControlsTechniqueMapping(
        mitreControlId,
        mitreControlName,
        data.subControls,
        t
      ...
      console.log(
        "Mitre Control updated successfully:",
        mitreControlId,
        mitreControlName
      );
  ...
  static async updateMitreControlStatus(
    mitreControlId,
    mitreControlName,
    status
  ) {
