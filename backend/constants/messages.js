module.exports = {
  ...
  PROCESS: {
    ...
    INVALID_RELATIONSHIP_TYPE:
      "Invalid relationship type for process dependency.",
    ...
    FAILED_TO_DOWNLOAD_PROCESS_TEMPLATE_FILE:
      "Failed to download process template file",
  },
  RISK_SCENARIO: {
    ...
    FAILED_TO_DOWNLOAD_RISK_SCENARIO_TEMPLATE_FILE:
      "Failed to download risk scenario template file",
  },
  ASSET: {
    ...
    INVALID_HOSTING_FACILITY_VALUE:
      "Invalid value for hosting facility in assets",
    ...
    FAILED_TO_DOWNLOAD_ASSET_TEMPLATE_FILE:
      "Failed to download asset template file",
  },
  MITRE_THREAT_CONTROL: {
    ...
    FAILED_TO_DOWNLOAD_TEMPLATE_FILE:
      "Failed to download Mitre ThreatControl Record template file",
  },
  MITRE_CONTROLS: {
