                ...
                tagItems={[
                  {
                    ...
                    value: item.processDependency?.length,
                  },
                  {
                    label: "Follows",
                    value: item.processDependency?.filter(
                      (pd) =>
                        (pd.relationshipType === "follows" &&
                          item.id === pd.sourceProcessId) ||
                        (pd.relationshipType === "precedes" &&
                          item.id === pd.targetProcessId)
                    )?.length,
                  },
                  {
                    label: "Precedes",
