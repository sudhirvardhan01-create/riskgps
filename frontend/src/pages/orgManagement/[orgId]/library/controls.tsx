...
function ControlsPage() {
  ...
  const handleDeleteSingleControl = (controlId: string | number) => {
  ...
  const toggleDescription = (controlId: string | number, event: React.MouseEvent) => {
  ...
  return (
    ...
    >
            ...
            <Box sx={{
              ...
              <Grid container spacing={2}>
                {filteredControls.map((control) => {
                  const isExpanded = expandedDescriptions.has(control.id);
                  const descriptionText = `Description: ${control.controlDescription}`;
                  const actualDescription = control.controlDescription || "";
                    ...
                    <Grid size={{ xs: 12, sm: 6 }} key={control.id}>
                      ...
                      >
                          ...
                          label={
                            <Box sx={{ flex: 1, pr: 4, display: "flex", flexDirection: "column" }}>
                              ...
                              <Box sx={{ position: "relative" }}>
                                ...
                                {shouldShowToggle && (
                                  <Button
                                    onClick={(e) => toggleDescription(control.id, e)}
                                    sx={{
                                      textTransform: "none",
                                      color: "#04139A",
                                      fontSize: "12px",
                        ...
                        <IconButton
                          onClick={(e) => {
                            e.stopPropagation();
                            handleDeleteSingleControl(control.id);
                          }}
                          sx={{
                            position: "absolute",
                            right: 8,
      ...
      <AddLibraryItemsModal
        ...
        itemType="controls"
        alreadyAddedIds={controls.map(control => control.id)}
      />
    </Box>
  );
}
